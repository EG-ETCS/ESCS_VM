#!/usr/bin/env bash
# Install minicom (serial modem / UART terminal).
# Package: minicom
...
is_installed() {
  package_installed "${PACKAGE_NAME}" && command_exists minicom
}
